...
class ControladorAgregarCliente(ControladorAlterarUsuario):
    def __init__(self):
        super().__init__()
        self.window.setWindowTitle("Agregar cliente")
    ...
    def aceptar(self):
        ...
        if m == QMessageBox.StandardButton.Yes:
            ...
            GestorUsuario.agregar(cliente)
            QMessageBox.information(
                self.window, "Sistema gestión librería", "Cliente agregado."
            )
